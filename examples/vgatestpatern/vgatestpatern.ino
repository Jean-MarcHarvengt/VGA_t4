...
void setup() {
  ...
  vga.drawRect(120,0,200,240,LIGHT_BLUE);
  ...
  */
  ...
  switch (fb_width) {
    case 320:
      vga.drawText(0,0,"0123456789012345678901234567890123456789",LIGHT_BLUE,WHITE(0xff),false);
      break;
    case 640:
      vga.drawText(0,0,"00112233445566778899001122334455667788990011223344556677889900112233445566778899",LIGHT_BLUE,WHITE(0xff),false);
      break;
  }
